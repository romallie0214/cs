...
<!-- Page specific script for Chart JS -->
<script>
  $(function () {
    /* ChartJS
     * -------
...
<!-- Page specific script for uPlot -->
<script>
  $(function () {
    /* ChartJS
     * -------
...
<!-- Page specific script General Forms-->
<script>
$(function () {
...
<!-- Page specific script for Advanced Forms-->
<script>
  $(function () {
...
<!--Page specific script for Editor's-->
<script>
  $(function () {
    // Summernote
...
<!-- Page specific script Validation's-->
<script>
$(function () {
...
<!-- Page specific script for DataTables-->
<script>
  $(function () {
    $("#example1").DataTable({
